    ...
    },
    {
      ...
      description: (
        <>
          ...
          improving responsiveness across devices. Utilized an Angular, Java,
          and AWS stack, significantly enhancing platform stability and user
          experience.
        </>
      ),
      image: "/angular.png",
